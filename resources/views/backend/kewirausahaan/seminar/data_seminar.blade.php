...
@section('title', 'Data Seminar Kewirausahaan')
@section('content')
                                ...
                                <div class="white_box_tittle list_header">
                                    ...
                                    <div class="box_right d-flex lms_block">
                                        ...
                                        <div class="add_button ml-10">
                                            <a href="{{route('seminar-kewirausahaan.create')}}" class="btn_1">Tambah Data</a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{route('seminar-kewirausahaan.update')}}" method="post" class="d-inline">
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{$i->id}}">
