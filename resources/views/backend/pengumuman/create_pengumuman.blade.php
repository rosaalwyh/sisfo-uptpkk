                    ...
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                            @if (count($errors) > 0)
                                ...
                                @endif
                            <form method="post" action="{{route('pengumuman.save')}}" enctype="multipart/form-data">
                                 {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="inputJudul">Judul</label>
                                    <input type="text" class="form-control" name="pengumuman_judul" id="inputJudul" placeholder="Masukan Judul Pengumuman" required>
                                </div>
                                <div class="form-group">
                                    <label>Pengumuman</label>
                                    <textarea name="pengumuman_konten" id="kt-ckeditor-1"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="inputSampul">Sampul</label>
                                    <input type="file" class="form-control-file" name="pengumuman_sampul" id="inputSampul" required>
                                </div>
                                <div class="form-group">
