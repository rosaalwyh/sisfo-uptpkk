...
@section('title', 'Update Seminar Kewirausahaan')
@section('content')
                        ...
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">Update Seminar Kewirausahaan</h3>
                                </div>
                            </div>
                        </div>
