...
@section('title', 'Form Seminar Kewirausahaan')
@section('content')
                    ...
                    <div class="white_card card_height_100 mb_30">
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <h3 class="m-0">Form Seminar Kewirausahaan</h3>
                            </div>
                        </div>
                        <div class="white_card_body">
                            ...
                            @if (count($errors) > 0)
                                ...
                                @endif
                            <form method="post" action="{{route('seminar-kewirausahaan.save')}}" enctype="multipart/form-data">
                                @csrf <!-- {{ csrf_field() }} -->
