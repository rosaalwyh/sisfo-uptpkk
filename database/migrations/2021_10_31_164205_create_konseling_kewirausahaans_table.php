...
class CreateKonselingKewirausahaansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('konseling_kewirausahaans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('konseling_kewirausahaans');
    }
}
