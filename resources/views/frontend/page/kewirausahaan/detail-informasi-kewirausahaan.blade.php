...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12 col-lg-6 mt-10">
            ...
            <div class="post__img">
                <a href="#">
                    <img src="{{asset('storage/informasi_kewirausahaan/'. $item->informasi_foto)}}" style="height: 390px" alt="blog image">
                </a>
            </div><!-- /.post-img -->
            </div>
        </div>
    ...
    <div class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="post__meta d-flex align-items-center mb-20">
            ...
            <div class="post__meta-cat">
                ...
                <a href="#">{{$item->informasi_penulis}}</a>
                </span>
            </div><!-- /.blog-meta-cat -->
        ...
        <div class="row row-no-gutter">
            ...
            <div class="blog-tags d-flex flex-wrap">
                ...
                <li><a href="#">{{$item->informasi_tanggal}}</a></li>
                </ul>
            </div><!-- /.blog-tags -->
            </div>
