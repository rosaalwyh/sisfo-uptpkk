...
@section('title', 'Data Konseling Kewirausahaan')
@section('content')
                                ...
                                <div class="white_box_tittle list_header">
                                    ...
                                    <div class="box_right d-flex lms_block">
                                        ...
                                        <div class="add_button ml-10">
                                            <a href="{{route('konseling-kewirausahaan.create')}}" class="btn_1">Tambah Data</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table lms_table_active3" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{asset('storage/konseling_kewirausahaan/'.$i->konseling_foto)}}" style="width: 100px"></td>
                                                <td>
                                                    <form action="{{route('konseling-kewirausahaan.delete')}}" method="post" class="d-inline">
                                                        @csrf
                                                        <input type="hidden" value="{{$i->konseling_foto}}" name="konseling_foto" id="">
                                                        <input type="hidden" name="id" value="{{$i->id}}">
                                                        <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                                    </form>
                                                    <form action="{{route('konseling-kewirausahaan.update')}}" method="post" class="d-inline">
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{$i->id}}">
